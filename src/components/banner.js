...
const Banner = () => {
    return (
        <div className={'bg-blue-600 text-white min-h-[60vh] py-5 flex items-center bg-cover bg-no-repeat relative'}
             style={{backgroundImage:`url(${background})`,backgroundBlendMode:'color-burn'}}>
             <img src={light} alt={'light'} className={'absolute -top-52 animate-pulse'}/>
            <div className={'max-w-7xl px-5 w-full mx-auto grid md:grid-cols-2 '}>
                <div className={'flex flex-col space-y-6 text-center md:text-left'}>
                    ...
                    <p className={'text-3xl md:text-5xl'}>From Cloudy to Clear
                    </p>
